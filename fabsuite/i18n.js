...
(function (g) {
  ...
  var DICT = {
    ...
    en: {
      ...
      "hero.lead": "{brand} is four tools built for a real workshop: <b>CRM</b> keeps every enquiry moving, <b>Offer</b> prices the job, <b>Nesting</b> optimizes cutting and offcuts, and <b>DB</b> runs the whole production flow — projects, steps and your team.",
      ...
      "features.h2": "Four tools. One workspace.",
      "features.sub": "Same logins, same clients, same warehouse — across all four apps.",
      ...
      "flow.sub": "The four apps hand work to each other. A phone call becomes a quote, a quote becomes a project, a project becomes a cutting plan.",
      ...
      "features.warehouse.p": "Offcuts and sheets are visible across all four apps in real time.",
      ...
      "how.s1.p": "One app, or all four at a discount. Monthly or yearly — switch anytime.",
      ...
      "plan.suite.tag": "Everything in one \u2014 all four apps at a discount.",
      "plan.suite.f": ["Everything in CRM, Offer, Nesting and DB", "One client \u2192 quote \u2192 project \u2192 cutting flow", "Shared warehouse across every app", "Priority support"],
      "plan.suite.miss": [],
    ...
    lt: {
      ...
      "hero.lead": "{brand} — keturi įrankiai, sukurti realiam baldų cechui: <b>CRM</b> veda kiekvieną užklausą, <b>Offer</b> suskaičiuoja kainą, <b>Nesting</b> optimizuoja pjovimą ir likučius, <b>DB</b> valdo visą gamybos eigą — projektus, žingsnius ir komandą.",
      ...
      "features.h2": "Keturi įrankiai. Viena darbo vieta.",
      "features.sub": "Tie patys prisijungimai, tie patys klientai, tas pats sandėlis — visose keturiose.",
      ...
      "flow.sub": "Keturios programos perduoda darbą viena kitai. Skambutis virsta pasiūlymu, pasiūlymas — projektu, projektas — pjovimo planu.",
      ...
      "features.warehouse.p": "Pjovimo likučiai ir lakštai matomi visose keturiose programose realiu laiku.",
      ...
      "how.s1.p": "Viena programa ar visos keturios su nuolaida. Mėnesinis ar metinis — keisk bet kada.",
      ...
      "plan.suite.name": "{brand}",
      "plan.suite.tag": "Viskas viename \u2014 visos keturios programos su nuolaida.",
      "plan.suite.f": ["Viskas i\u0161 CRM, Offer, Nesting ir DB", "Klientas \u2192 pasi\u016blymas \u2192 projektas \u2192 pjovimas", "Bendras sand\u0117lis visose programose", "Prioritetin\u0117 pagalba"],
      "plan.suite.miss": [],
    ...
    de: {
      ...
      "features.h2": "Vier Werkzeuge. Ein Arbeitsbereich.",
      "features.sub": "Gleiche Logins, gleiche Kunden, gleiches Lager — in allen vier Apps.",
      ...
      "flow.sub": "Die vier Apps reichen die Arbeit weiter. Aus einem Anruf wird ein Angebot, aus dem Angebot ein Projekt, aus dem Projekt ein Schnittplan.",
      ...
      "features.warehouse.p": "Reststücke und Platten sind in allen vier Apps in Echtzeit sichtbar.",
      ...
      "how.s1.p": "Eine App oder alle vier mit Rabatt. Monatlich oder jährlich — jederzeit wechselbar.",
      ...
      "plan.suite.name": "{brand}",
      "plan.suite.tag": "Alles in einem \u2014 alle vier Apps mit Rabatt.",
      "plan.suite.f": ["Alles aus CRM, Offer, Nesting und DB", "Kunde \u2192 Angebot \u2192 Projekt \u2192 Zuschnitt", "Gemeinsames Lager \u00fcber alle Apps", "Priorisierter Support"],
      "plan.suite.miss": [],
    ...
    es: {
      ...
      "hero.lead": "{brand} son cuatro herramientas creadas para un taller real: <b>CRM</b> mueve cada consulta, <b>Offer</b> calcula el precio, <b>Nesting</b> optimiza el corte y los retales, y <b>DB</b> gestiona todo el flujo de producción — proyectos, pasos y tu equipo.",
      ...
      "features.h2": "Cuatro herramientas. Un espacio.",
      "features.sub": "Mismos accesos, mismos clientes, mismo almacén — en las cuatro apps.",
      ...
      "flow.sub": "Las cuatro apps se pasan el trabajo. Una llamada se convierte en presupuesto, el presupuesto en proyecto, el proyecto en plan de corte.",
      ...
      "features.warehouse.p": "Retales y tableros visibles en las cuatro apps en tiempo real.",
      ...
      "how.s1.p": "Una app o las cuatro con descuento. Mensual o anual — cambia cuando quieras.",
      ...
      "plan.suite.name": "{brand}",
      "plan.suite.tag": "Todo en uno \u2014 las cuatro apps con descuento.",
      "plan.suite.f": ["Todo de CRM, Offer, Nesting y DB", "Cliente \u2192 presupuesto \u2192 proyecto \u2192 corte", "Almac\u00e9n compartido en todas las apps", "Soporte prioritario"],
      "plan.suite.miss": [],
  ...
  Object.assign(DICT.en, {
    ...
    "compare.v.price.you": "€29–89/mo", "compare.v.price.sheets": "Low",
  ...
  Object.assign(DICT.lt, {
    ...
    "compare.v.price.you": "29–89 €/mėn.", "compare.v.price.sheets": "Maža",
    "compare.v.price.nesting": "€€", "compare.v.price.erp": "€€€€",
  ...
  Object.assign(DICT.de, {
    ...
    "compare.v.price.you": "29–89 €/Mon.", "compare.v.price.sheets": "Gering",
    "compare.v.price.nesting": "€€", "compare.v.price.erp": "€€€€",
  ...
  Object.assign(DICT.es, {
    ...
    "compare.v.price.you": "29–89 €/mes", "compare.v.price.sheets": "Bajo",
    "compare.v.price.nesting": "€€", "compare.v.price.erp": "€€€€",
