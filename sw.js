...
const SHELL = [
  ...
  "wb.js", "scan.js", "gpm.js", "swood.js", "reports.js", "insights.js", "files.js", "bridge.js", "sync.js",
  "manifest.json",
...
self.addEventListener("fetch", (e) => {
  ...
  // CraftOS build: the storefront and the admin console are siblings
  // under the same Pages path and are none of this worker's business.
  if (/\/(fabsuite|admin)(\/|$)/.test(url.pathname)) return;
